...
export default function ProductCard({ product }: Props) {
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="aspect-square w-full overflow-hidden bg-sky-50 relative">
  {product.images[0] ? (
    <img
  ...
  <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full px-2.5 py-0.5 text-xs font-medium text-pink-400">
    {product.category}
  </div>
</div>
